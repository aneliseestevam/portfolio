...
const projects = [
  {
    ...
    demoMode: 'https://todaescola.vercel.app/dashboard'
  },
  {
            ...
            >
              ...
              <div className="flex-1 flex flex-col p-6 gap-3">
                ...
                <div className="flex flex-wrap gap-4 mt-auto">
                  ...
                  {project.demoMode && (
                    <Link href={project.demoMode} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-purple-400 hover:text-pink-400 font-medium transition-colors">
